...
import MonthPeriodSelectionSheet from '@/components/mobile/MonthPeriodSelectionSheet.vue';
...
app.component('MonthPeriodSelectionSheet', MonthPeriodSelectionSheet);
