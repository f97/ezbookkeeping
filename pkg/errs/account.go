...
var (
	...
	ErrCannotSetSavingsFieldsForNonSavingsAccount  = NewNormalError(NormalSubcategoryAccount, 23, http.StatusBadRequest, "cannot set savings fields for non savings account")
)
